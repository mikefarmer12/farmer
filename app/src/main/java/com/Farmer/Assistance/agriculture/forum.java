...
public class forum extends ActionBarActivity {
      ...
      read();
        ...
        chatView.setOnSentMessageListener(new ChatView.OnSentMessageListener(){
            ...
            public boolean sendMessage(ChatMessage chatMessage){
                Firebase ref = new Firebase("https://farmer-master-c97ff.firebaseio.com/FORUMS/");
    ...
    public void read()
    {
        ...
        final Firebase ref = new Firebase("https://farmer-master-c97ff.firebaseio.com/FORUMS/");
